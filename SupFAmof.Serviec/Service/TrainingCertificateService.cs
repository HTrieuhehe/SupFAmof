...
//                    await _unitOfWork.Repository<Certif>()
//                        .GetAll()
...
//            }
//        }
//        private async Task<bool> CheckOverlapPostRegistration(InterviewDay request, int accountId)
//        {
...
//            return (start1 < end2 && end1 > start2);
//        }
//        private async Task<bool> AssignDuplicateTime(CertificateRegistration request,
...
//                await _unitOfWork.Repository<CertificateRegistration>().UpdateDetached(trainingRegistration);
//                await _unitOfWork.CommitAsync();
//                return new BaseResponseViewModel<dynamic>
//                {
//                    Status = new StatusViewModel()
