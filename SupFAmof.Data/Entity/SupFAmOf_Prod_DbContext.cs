...
//                optionsBuilder.UseSqlServer("Server=3.0.33.161;Database=SupFAmOf_Stg_Db;User ID=sa;Password=QW0%mG0#%jRC3Z7&T4fL38ygt5Jhhx;MultipleActiveResultSets=true;Integrated Security=true;Trusted_Connection=False;Encrypt=True;TrustServerCertificate=True", x => x.UseNetTopologySuite());
//            }
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Application>(entity =>
            {
                ...
                entity.HasOne(d => d.AccountReply)
                    ...
                    .HasConstraintName("FK_Application_Account1");
            });
            ...
            modelBuilder.Entity<InterviewDay>(entity =>
            {
                entity.ToTable("InterviewDay");
